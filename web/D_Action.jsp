...
System.out.println("D_Action.jsp:"+dkey);
String query="select * from request where dkey='"+dkey+"'";
ResultSet rs=Queries.getExecuteQuery(query);
String arr[];
if(rs.next()){
    String query1="select * from request where dkey='"+dkey+"'";
ResultSet rs1=Queries.getExecuteQuery(query1);
while(rs1.next()){
...
%>
            ...
            <table>
                <tr><th><%=filename%></th><td><a href="D1.jsp?fname=<%=filename%>">Download</a></td></tr>
        </table>
...

{
    ...
    <script type="text/javascript">
        window.alert("Please Enter Correct Download Key");
        window.location="Downoad.jsp";
        </script>
    <%
}
            %>
